...
describe('Testing `getNumber` with `es` locale on positive numbers', () => {
  test(`(Manually) It should return a positive decimal literal when given an 
  implicitly positive string representation`, () => {
    expect(getNumber('0,0', 'es')).toBeCloseTo(0.0, supportedNumberOfFractionDigits);
    expect(getNumber('0,45', 'es')).toBeCloseTo(0.45, supportedNumberOfFractionDigits);
    expect(getNumber('0,3', 'es')).toBeCloseTo(0.3, supportedNumberOfFractionDigits);
    expect(getNumber('0,243225', 'es')).toBeCloseTo(0.243225, supportedNumberOfFractionDigits);
    expect(getNumber('200', 'es')).toBeCloseTo(200, supportedNumberOfFractionDigits);
    expect(getNumber('200,45', 'es')).toBeCloseTo(200.45, supportedNumberOfFractionDigits);
    expect(getNumber('873,00', 'es')).toBeCloseTo(873.0, supportedNumberOfFractionDigits);
    expect(getNumber('2.050', 'es')).toBeCloseTo(2050, supportedNumberOfFractionDigits);
    expect(getNumber('2050', 'es')).toBeCloseTo(2050, supportedNumberOfFractionDigits);
    expect(getNumber('2.000,30', 'es')).toBeCloseTo(2000.3, supportedNumberOfFractionDigits);
    expect(getNumber('2000,30', 'es')).toBeCloseTo(2000.3, supportedNumberOfFractionDigits);
    expect(getNumber('2.342,0', 'es')).toBeCloseTo(2342.0, supportedNumberOfFractionDigits);
    expect(getNumber('2342,0', 'es')).toBeCloseTo(2342.0, supportedNumberOfFractionDigits);
    expect(getNumber('20.000', 'es')).toBeCloseTo(20000, supportedNumberOfFractionDigits);
    expect(getNumber('20.000,34', 'es')).toBeCloseTo(20000.34, supportedNumberOfFractionDigits);
    expect(getNumber('200.000', 'es')).toBeCloseTo(200000, supportedNumberOfFractionDigits);
    expect(getNumber('2.000.000', 'es')).toBeCloseTo(2000000, supportedNumberOfFractionDigits);
    expect(getNumber('12.054.100,55', 'es')).toBeCloseTo(12054100.55, supportedNumberOfFractionDigits);
  });
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 0, 0, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 1, 100, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 100, 1000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 1000, 10000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 10000, 100000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 100000, 1000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 1000000, 10000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 10000000, 100000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 100000000, 1000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 1000000000, 10000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 10000000000, 100000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 100000000000, 1000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 1000000000000, 10000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('es', 10000000000000, 100000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
...
describe('Testing `getNumber` with `es` locale on negative numbers', () => {
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', 0, -2, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -100, -1, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -1000, -100, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -10000, -1000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -100000, -10000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -1000000, -100000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -10000000, -1000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -100000000, -10000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -1000000000, -100000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -10000000000, -1000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -100000000000, -10000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -1000000000000, -100000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('es', -10000000000000, -1000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'es')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
...
describe('Testing `getNumber` with `es` locale on invalid cases', () => {
  test(`(Manually) It should return 'null' when the given number does not
  match the given locale`, () => {
    expect(getNumber('120,000.23', 'es')).toBe(null);
    expect(getNumber('12 000.23', 'es')).toBe(null);
    expect(getNumber("12'000,23", 'es')).toBe(null);
  });

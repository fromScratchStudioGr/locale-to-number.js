...
describe('Testing `getNumber` with `nl` locale on positive numbers', () => {
  test(`(Manually) It should return a positive decimal literal when given an 
  implicitly positive string representation`, () => {
    expect(getNumber('0,0', 'nl')).toBeCloseTo(0.0, supportedNumberOfFractionDigits);
    expect(getNumber('0,45', 'nl')).toBeCloseTo(0.45, supportedNumberOfFractionDigits);
    expect(getNumber('0,3', 'nl')).toBeCloseTo(0.3, supportedNumberOfFractionDigits);
    expect(getNumber('0,243225', 'nl')).toBeCloseTo(0.243225, supportedNumberOfFractionDigits);
    expect(getNumber('200', 'nl')).toBeCloseTo(200, supportedNumberOfFractionDigits);
    expect(getNumber('200,45', 'nl')).toBeCloseTo(200.45, supportedNumberOfFractionDigits);
    expect(getNumber('873,00', 'nl')).toBeCloseTo(873.0, supportedNumberOfFractionDigits);
    expect(getNumber('2.050', 'nl')).toBeCloseTo(2050, supportedNumberOfFractionDigits);
    expect(getNumber('2050', 'nl')).toBeCloseTo(2050, supportedNumberOfFractionDigits);
    expect(getNumber('2.000,30', 'nl')).toBeCloseTo(2000.3, supportedNumberOfFractionDigits);
    expect(getNumber('2000,30', 'nl')).toBeCloseTo(2000.3, supportedNumberOfFractionDigits);
    expect(getNumber('2.342,0', 'nl')).toBeCloseTo(2342.0, supportedNumberOfFractionDigits);
    expect(getNumber('2342,0', 'nl')).toBeCloseTo(2342.0, supportedNumberOfFractionDigits);
    expect(getNumber('20.000', 'nl')).toBeCloseTo(20000, supportedNumberOfFractionDigits);
    expect(getNumber('20000', 'nl')).toBeCloseTo(20000, supportedNumberOfFractionDigits);
    expect(getNumber('20.000,34', 'nl')).toBeCloseTo(20000.34, supportedNumberOfFractionDigits);
    expect(getNumber('20000,34', 'nl')).toBeCloseTo(20000.34, supportedNumberOfFractionDigits);
    expect(getNumber('200.000', 'nl')).toBeCloseTo(200000, supportedNumberOfFractionDigits);
    expect(getNumber('200000', 'nl')).toBeCloseTo(200000, supportedNumberOfFractionDigits);
    expect(getNumber('2.000.000', 'nl')).toBeCloseTo(2000000, supportedNumberOfFractionDigits);
    expect(getNumber('2000000', 'nl')).toBeCloseTo(2000000, supportedNumberOfFractionDigits);
    expect(getNumber('12.054.100,55', 'nl')).toBeCloseTo(12054100.55, supportedNumberOfFractionDigits);
    expect(getNumber('12054100,55', 'nl')).toBeCloseTo(12054100.55, supportedNumberOfFractionDigits);
  });
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 0, 0, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 1, 100, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 100, 1000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 1000, 10000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 10000, 100000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 100000, 1000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 1000000, 10000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 10000000, 100000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 100000000, 1000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 1000000000, 10000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 10000000000, 100000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 100000000000, 1000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 1000000000000, 10000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  implicitly positive string representation`, () => {
    const testCases = testCaseGenerator('nl', 10000000000000, 100000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
...
describe('Testing `getNumber` with `nl` locale on negative numbers', () => {
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', 0, -2, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -100, -1, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -1000, -100, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -10000, -1000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -100000, -10000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -1000000, -100000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -10000000, -1000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -100000000, -10000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -1000000000, -100000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -10000000000, -1000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -100000000000, -10000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -1000000000000, -100000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
  ...
  negative string representation`, () => {
    const testCases = testCaseGenerator('nl', -10000000000000, -1000000000000, 1000);
    testCases.forEach((testCase) => {
      expect(getNumber(testCase.stringRepresentation, 'nl')).toBeCloseTo(
        testCase.groundTruth,
        supportedNumberOfFractionDigits
...
describe('Testing `getNumber` with `nl` locale on invalid cases', () => {
  test(`(Manually) It should return 'null' when the given number does not
  match the given locale`, () => {
    expect(getNumber('120,000.23', 'nl')).toBe(null);
    expect(getNumber('12 000.23', 'nl')).toBe(null);
    expect(getNumber("12'000,23", 'nl')).toBe(null);
  });

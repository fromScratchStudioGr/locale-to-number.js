...
describe('Testing `getNumber` with `fr-CA` locale on positive numbers', () => {
  ...
  implicitly positive string representation`, () => {
    ...
    expect(getNumber('2050', 'fr-CA')).toBeCloseTo(2050, supportedNumberOfFractionDigits);
    expect(getNumber('2 000,30', 'fr-CA')).toBeCloseTo(2000.3, supportedNumberOfFractionDigits);
    expect(getNumber('2000,30', 'fr-CA')).toBeCloseTo(2000.3, supportedNumberOfFractionDigits);
    expect(getNumber('2 342,0', 'fr-CA')).toBeCloseTo(2342.0, supportedNumberOfFractionDigits);
    expect(getNumber('2342,0', 'fr-CA')).toBeCloseTo(2342.0, supportedNumberOfFractionDigits);
    expect(getNumber('20 000', 'fr-CA')).toBeCloseTo(20000, supportedNumberOfFractionDigits);
    expect(getNumber('20000', 'fr-CA')).toBeCloseTo(20000, supportedNumberOfFractionDigits);
    expect(getNumber('20 000,34', 'fr-CA')).toBeCloseTo(20000.34, supportedNumberOfFractionDigits);
    expect(getNumber('20000,34', 'fr-CA')).toBeCloseTo(20000.34, supportedNumberOfFractionDigits);
    expect(getNumber('200 000', 'fr-CA')).toBeCloseTo(200000, supportedNumberOfFractionDigits);
    expect(getNumber('200000', 'fr-CA')).toBeCloseTo(200000, supportedNumberOfFractionDigits);
    expect(getNumber('2 000 000', 'fr-CA')).toBeCloseTo(2000000, supportedNumberOfFractionDigits);
    expect(getNumber('2000000', 'fr-CA')).toBeCloseTo(2000000, supportedNumberOfFractionDigits);
    expect(getNumber('12 054 100,55', 'fr-CA')).toBeCloseTo(12054100.55, supportedNumberOfFractionDigits);
    expect(getNumber('12054100,55', 'fr-CA')).toBeCloseTo(12054100.55, supportedNumberOfFractionDigits);
  });
...
describe('Testing `getNumber` with `fr-CA` locale on invalid cases', () => {
  test(`(Manually) It should return 'null' when the given number does not
  match the given locale`, () => {
    expect(getNumber('120.000,23', 'fr-CA')).toBe(null);
    expect(getNumber('12 000.23', 'fr-CA')).toBe(null);
    expect(getNumber("12'000,23", 'fr-CA')).toBe(null);
  });
